# app/models/preference_sport.py
...
class PreferenceSport(Base):
    ...
    sport_type_id = Column(Integer, ForeignKey("sport_types.sport_type_id"), primary_key=True)
    ...
    sport_type = relationship("SportType", back_populates="preference_sports")
     ...
     # 設置唯一約束
    __table_args__ = (
        UniqueConstraint('preference_id', 'sport_type_id', name='uq_preference_sport_id'),
    )
