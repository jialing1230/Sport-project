"""add current_participants to activities

Revision ID: 2e034a52d772
Revises: f47ac10b58cc
Create Date: 2025-05-02 14:38:07.109032
...
def upgrade() -> None:
    ...
    op.add_column('activities', sa.Column('current_participants', sa.Integer(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('activities', 'current_participants')
    # ### end Alembic commands ###
